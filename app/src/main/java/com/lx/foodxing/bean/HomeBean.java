...
public class HomeBean {
    ...
    private IntegralMallPicBean integralMallPic;
    private ToShareCodeBean toShareCode;
    private AdvertesPictureBean advertesPicture;
    private SaomaBean saoma;
    private NewUserBean newUser;
    private Floor1PicBean floor1Pic;
    private Floor2PicBean floor2Pic;
    private FloorNameBean floorName;
    private Floor3PicBean floor3Pic;
    private List<SlidesBean> slides;
    private List<RecommendBean> recommend;
    private List<Floor1Bean> floor1;
    private List<Floor2Bean> floor2;
    private List<Floor3Bean> floor3;
    private List<CategoryBean> category;
    private List<String> reservationGoods;
    ...
    public IntegralMallPicBean getIntegralMallPic() {
        return integralMallPic;
    }

    public void setIntegralMallPic(IntegralMallPicBean integralMallPic) {
        this.integralMallPic = integralMallPic;
    }

    public ToShareCodeBean getToShareCode() {
        return toShareCode;
    }

    public void setToShareCode(ToShareCodeBean toShareCode) {
        this.toShareCode = toShareCode;
    }
    ...
    public SaomaBean getSaoma() {
        return saoma;
    }

    public void setSaoma(SaomaBean saoma) {
        this.saoma = saoma;
    }
    ...
    public Floor1PicBean getFloor1Pic() {
        return floor1Pic;
    }

    public void setFloor1Pic(Floor1PicBean floor1Pic) {
        this.floor1Pic = floor1Pic;
    }

    public Floor2PicBean getFloor2Pic() {
        return floor2Pic;
    }

    public void setFloor2Pic(Floor2PicBean floor2Pic) {
        this.floor2Pic = floor2Pic;
    }

    public FloorNameBean getFloorName() {
        return floorName;
    }

    public void setFloorName(FloorNameBean floorName) {
        this.floorName = floorName;
    }

    public Floor3PicBean getFloor3Pic() {
        return floor3Pic;
    }

    public void setFloor3Pic(Floor3PicBean floor3Pic) {
        this.floor3Pic = floor3Pic;
    }
    ...
    public List<Floor1Bean> getFloor1() {
        return floor1;
    }

    public void setFloor1(List<Floor1Bean> floor1) {
        this.floor1 = floor1;
    }

    public List<Floor2Bean> getFloor2() {
        return floor2;
    }

    public void setFloor2(List<Floor2Bean> floor2) {
        this.floor2 = floor2;
    }

    public List<Floor3Bean> getFloor3() {
        return floor3;
    }

    public void setFloor3(List<Floor3Bean> floor3) {
        this.floor3 = floor3;
    }
    ...
    public List<String> getReservationGoods() {
        return reservationGoods;
    }

    public void setReservationGoods(List<String> reservationGoods) {
    ...
    public static class IntegralMallPicBean {
        /**
    ...
    public static class ToShareCodeBean {
        /**
    ...
    public static class Floor1PicBean {
        /**
    ...
    public static class Floor2PicBean {
        /**
    ...
    public static class Floor3PicBean {
        /**
    ...
    public static class Floor1Bean {
        /**
    ...
    public static class Floor2Bean {
        /**
    ...
    public static class Floor3Bean {
        /**
    ...
    public static class CategoryBean {
        ...
        private String image;
        private List<BxMallSubDtoBean> bxMallSubDto;
        ...
        public String getMallCategoryName() {
            return mallCategoryName;
        }

        public void setMallCategoryName(String mallCategoryName) {
            this.mallCategoryName = mallCategoryName;
        }
        ...
        public List<BxMallSubDtoBean> getBxMallSubDto() {
            return bxMallSubDto;
        }

        public void setBxMallSubDto(List<BxMallSubDtoBean> bxMallSubDto) {
            this.bxMallSubDto = bxMallSubDto;
        }

        public static class BxMallSubDtoBean {
            /**
            ...
            public String getMallSubId() {
                return mallSubId;
            }

            public void setMallSubId(String mallSubId) {
                this.mallSubId = mallSubId;
            }
            ...
            public String getMallSubName() {
                return mallSubName;
            }

            public void setMallSubName(String mallSubName) {
